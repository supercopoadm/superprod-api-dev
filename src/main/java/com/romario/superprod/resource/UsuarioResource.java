...
import com.romario.superprod.security.resource.CheckSecurity;
import com.romario.superprod.service.UsuarioService;
...
//	}
	...
	@RequestMapping(value = "/{id}/resest", method = RequestMethod.PUT)
	public ResponseEntity<?> alterarsenha(@PathVariable Integer id) {
		Usuario usu = service.resetSenha(id);
		usu.setPermissoes(null);
		return ResponseEntity.ok().body(usu);
