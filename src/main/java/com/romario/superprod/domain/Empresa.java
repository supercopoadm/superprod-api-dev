...
public class Empresa {
	...
	public String toString() {
		return "Empresa [id=" + id + ", cidade=" + cidade + ", razaosocial=" + razaosocial + ", cpfoucnpj=" + cpfoucnpj
				+ ", naturezapessoa=" + naturezapessoa + ", uf=" + uf + ", valor=" + valor + ", cep=" + cep
				+ ", logradouro=" + logradouro + ", numero=" + numero + ", complemento=" + complemento + ", bairro="
				+ bairro + ", nomecontato=" + nomecontato + ", telefone=" + telefone + ", whats=" + whats + ", email="
				+ email + ", status=" + status + ", editar=" + editar + ", tenant_id=" + tenant_id + ", logs=" + logs
				+ "]";
	}
